...
import { BookReport, BookReportItem } from 'src/app/shared/bookreport';
...
addEmployee(employee: Employee): Observable<string> {
  return this.httpClient.post<string>(`${this.apiUrl}Employee/AddEmployee`, employee)
    .pipe(catchError(this.handleError));
}

updateEmployee(id: number, employee: Employee): Observable<string> {
  return this.httpClient.put<string>(`${this.apiUrl}Employee/UpdateEmployee/${id}`, employee)
    .pipe(catchError(this.handleError));
}

deleteEmployee(id: number): Observable<string> {
  return this.httpClient.delete<string>(`${this.apiUrl}Employee/DeleteEmployee/${id}`)
    .pipe(catchError(this.handleError));
}
...
//---------------------------------------------------------------------Stock Take-----------------------------
  ...
  updateBookStock(model: any): Observable<any> {
    return this.httpClient.post(`${this.apiUrl}StockTake/UpdateBookStock`, model, this.httpOptions);
  }

  updateEquipmentStock(model: any): Observable<any> {
    return this.httpClient.post(`${this.apiUrl}StockTake/UpdateEquipmentStock`, model, this.httpOptions);
  }
